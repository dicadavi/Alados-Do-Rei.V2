import { Box, Typography, List, ListItem, Avatar, ListItemText, ListItemAvatar, Chip } from '@mui/material';
                ...
                {item.rank <= 3 ? (
                  ...
                  <Typography 
                    ...
                    sx={{
                      ...
                      fontWeight: 700,
                      fontSize: '1.2rem',
                      color: item.rank >= 4 && item.rank <= 10 ? 'rgb(2, 41, 200)' : '#fff',
                      textShadow: item.rank > 10 ? '0 0 2px rgba(0,0,0,0.5)' : 'none'
                    }}
                  >
                    {item.rank}
                  </Typography>
